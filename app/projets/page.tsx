					...
					<div className="md:w-2/3 md:order-1 ml-5">
						...
						<section className="text-left">
							<p className="font-normal text-gray-700 dark:text-gray-400">
								J&apos;apprends à coder tous les jours par une pratique
								constante en école et sur mon temps libre. Chez Ada, encadré.e.s
								par des dévs professionnels nous apprenons en itérations de deux
								semaines : notions plus théoriques et travail de groupe. Nous
								sommes incités à apprendre ensemble dans un esprit sain,
								favorisant l&apos;entraide et la transmission plutôt que la
								compétition.
							</p>
							<p className="font-normal text-gray-700 dark:text-gray-400">
								Sur mon temps libre, je profite de repasser sur les technologies
								qui m&apos;intriguent le plus, ou qui m&apos;amusent (comme
								coder un Snake avec P5js).
							</p>
							<p className="font-normal text-green-700 dark:text-gray-400">
								<br />
								&#x2794;{" "}
								<Link href="https://github.com/elsacatoire">
									Pour jeter un oeil à mon travail d&apos;apprenante : GitHub
									profil
								</Link>
							</p>
							<br />
						...
						<div className="h-full max-w-m p-6 bg-gray-300 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
							...
							<p className="font-normal text-gray-700 dark:text-gray-400">
								&#x2022; Travailler avec une API d&apos;IA
							</p>
							<br />
							<p className="font-normal text-gray-700 dark:text-gray-400">
								&#x2022; site de révision/flash cards sur des notions techs et
								dévleoppement (perso)
							</p>
						</div>
					</div>
