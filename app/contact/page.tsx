	...
	return (
		<div className="">
			<div className="flex flex-col-reverse md:flex-row md:space-x-8 items-start">
				<div className="md:w-2/3 md:order-2 md:ml-5">
					<h1 className="text-center md:px-10 md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
					...
					<section className="text-center">
						<h2 className="text-center mx-auto md:text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
						...
						<h2 className="text-center mb-2 md:text-1xl font-bold tracking-tight text-green-700 dark:text-white">
							&#x2794;{" "}
