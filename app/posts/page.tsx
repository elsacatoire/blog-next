					...
					<div className="md:w-2/3 md:order-1s mx-auto">
						...
						<section className="text-left">
							<p className="font-normal text-base text-gray-700 dark:text-gray-400">
								...
								paroles s&apos;envolent, les écrits restent&ldquo;, sensible à
								la formalisation écrite des chemins de pensées, au travail comme
								en dehors, l&apos;écrit a une importance particulière pour moi.
								Ces écrits, très personnels et fixés dans leur contexte,
								reflètent mes réflexions et humeurs du moment.
							</p>
