		...
		<nav className="bg-gray-200 border-gray-200 dark:bg-gray-900 p-2 sticky top-0 drop-shadow-xl z-10">
			<div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto md:p-4">
				...
				<button
					type="button"
					onClick={toggleMenu}
					className="md:hidden inline-flex items-center p-2 w-10 h-10 text-gray-900 dark:text-white hover:text-white hover:bg-gray-900 dark:hover:bg-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700"
				>
