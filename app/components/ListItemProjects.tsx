...
export default function ListItemProject({ post }: Props) {
    ...
    return (
        ...
        <Link className="mt-5 flex flex-col items-center rounded-lg bg-gray-200 border border-green-700 shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700" href={`/projets/${id}`}>
